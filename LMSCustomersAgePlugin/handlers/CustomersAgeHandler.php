...
class CustomersAgeHandler {
    ...
    public function smartyCustomersAge(Smarty $hook_data) {
        ...
        if (!empty(LMSCustomersAgePlugin::PLUGIN_TEMPLATE_NAME) && file_exists($plugin_templates . DIRECTORY_SEPARATOR . LMSCustomersAgePlugin::PLUGIN_TEMPLATE_NAME) && !is_file($plugin_templates . DIRECTORY_SEPARATOR . LMSCustomersAgePlugin::PLUGIN_TEMPLATE_NAME)) {
            $plugin_templates = PLUGINS_DIR . DIRECTORY_SEPARATOR . LMSCustomersAgePlugin::PLUGIN_DIRECTORY_NAME . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . LMSCustomersAgePlugin::PLUGIN_TEMPLATE_NAME;
        }
