...
class EventsSummaryHandler {
    ...
    public function smartyEventsSummary(Smarty $hook_data) {
        ...
        if (!empty(EventsSummaryPlugin::PLUGIN_TEMPLATE_NAME) && file_exists($plugin_templates . DIRECTORY_SEPARATOR . EventsSummaryPlugin::PLUGIN_TEMPLATE_NAME) && !is_file($plugin_templates . DIRECTORY_SEPARATOR . EventsSummaryPlugin::PLUGIN_TEMPLATE_NAME)) {
            $plugin_templates = PLUGINS_DIR . DIRECTORY_SEPARATOR . EventsSummaryPlugin::PLUGIN_DIRECTORY_NAME . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . EventsSummaryPlugin::PLUGIN_TEMPLATE_NAME;
        }
