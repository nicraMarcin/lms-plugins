...
class CashImportOKBSHandler {
    ...
    public function smartyCashImportOKBS(Smarty $hook_data) {
        ...
        if (!empty(LMSCashImportOKBSPlugin::PLUGIN_TEMPLATE_NAME) && file_exists($plugin_templates . DIRECTORY_SEPARATOR . LMSCashImportOKBSPlugin::PLUGIN_TEMPLATE_NAME) && !is_file($plugin_templates . DIRECTORY_SEPARATOR . LMSCashImportOKBSPlugin::PLUGIN_TEMPLATE_NAME)) {
            $plugin_templates = PLUGINS_DIR . DIRECTORY_SEPARATOR . LMSCashImportOKBSPlugin::PLUGIN_DIRECTORY_NAME . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . LMSCashImportOKBSPlugin::PLUGIN_TEMPLATE_NAME;
        }
