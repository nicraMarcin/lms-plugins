...
class NodeIpChangelogHandler
{
    ...
    public function smartyNodeIpChangelog(Smarty $hook_data)
    {
        ...
        if (!empty(LMSNodeIpChangelogPlugin::PLUGIN_TEMPLATE_NAME) && file_exists($plugin_templates . DIRECTORY_SEPARATOR . LMSNodeIpChangelogPlugin::PLUGIN_TEMPLATE_NAME) && !is_file($plugin_templates . DIRECTORY_SEPARATOR . LMSNodeIpChangelogPlugin::PLUGIN_TEMPLATE_NAME)) {
            $plugin_templates = PLUGINS_DIR . DIRECTORY_SEPARATOR . LMSNodeIpChangelogPlugin::PLUGIN_DIRECTORY_NAME . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . LMSNodeIpChangelogPlugin::PLUGIN_TEMPLATE_NAME;
        }
